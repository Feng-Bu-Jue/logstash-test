using LogStashExemple.API.Infra.Configurations.Logs.LogModels;
...
namespace LogStashExemple.API.Infra.Configurations.Logs
{
    public class LogRequestActionFilter : IAsyncActionFilter
    {
        private static readonly ILogger Log = global::Serilog.Log.ForContext<LogRequestActionFilter>();
        private const string MessageTemplate = "HTTP {RequestMethod} {RequestPath} {@RequestBody} responded {@ResponseBody} {StatusCode} in {Elapsed:0.0000} ms";
